...
function themetechmount_sticky() {
    if (typeof jQuery.fn.stick_in_parent == "function") {
        ...
        if (parseInt(pageWidth) > parseInt(tm_breakpoint)) {
            jQuery('.tm-stickable-header').stick_in_parent({
                'parent': 'body',
                'spacer': !1,
        ...
        jQuery('iframe[src^="https://www.google.com/maps/"], iframe[src^="http://www.google.com/maps/"]', mainthis).each(function() {
            if (!jQuery(this).hasClass('themetechmount-set-gmap')) {
                ...
                jQuery(this).load(function() {
                    jQuery(this).addClass('themetechmount-set-gmap').animate({
                        opacity: 1
                    }, 1000)
                })
            }
...
function axacus_logMarginPadding() {
    jQuery('.wpb_column').each(function() {
        if (jQuery(this).hasClass('tm-left-span')) {
            ...
            randomclass = 'axacus-random-class-' + randomclass;
...
function axacus_logMarginPadding_right() {
    jQuery('.wpb_column').each(function() {
...
function axacus_menuhover_item() {
    ...
    var active_item = jQuery("#site-header-menu #site-navigation div.mega-menu-wrap ul.mega-menu.mega-menu-horizontal,#site-header-menu #site-navigation div.nav-menu > ul").children('.mega-current-menu-ancestor, .mega-current-menu-parent, .current-menu-ancestor, .current-menu-parent,.current-menu-item');
...
function axacus_circle_progress_counter() {
...
jQuery(document).ready(function($) {
    ...
    jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .tm-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='tm-axacus-icon-angle-down'></i></span>");
    ...
    jQuery('.tm-mmmenu-override-yes #site-navigation .mega-menu-wrap > ul > li.menu-item-language').hover(function() {
    ...
    jQuery('.righticon').on('click', function() {
        if (jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')) {
            ...
            jQuery('i', jQuery(this)).removeClass('tm-axacus-icon-angle-up').addClass('tm-axacus-icon-angle-down')
        } else {
            jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');
            jQuery('i', jQuery(this)).removeClass('tm-axacus-icon-angle-down').addClass('tm-axacus-icon-angle-up')
        }
        return !1
    });
    ...
    axacus_circle_progress_counter();
    jQuery("a[data-gal^='prettyPhoto']").prettyPhoto({
        hook: 'data-gal'
    });
    jQuery(".themetechmount-slider-wrapper > div > div > div:contains('Revolution Slider Error')").css("margin-top", "0");
    jQuery('select').select2();
    axacus_logMarginPadding();
    axacus_logMarginPadding_right();
    jQuery('.vc_row-o-equal-height, .tm-equalheightdiv').each(function() {
        var thisRow = jQuery(this);
        jQuery('.wpb_column', thisRow).each(function() {
            var thisColumn = jQuery(this);
            if (((jQuery('.tm-col-wrapper-bg-layer', thisColumn).length > 0 && (jQuery('.tm-col-wrapper-bg-layer', thisColumn).css('background-image') != 'none')) || (jQuery('.vc_column-inner', thisColumn).length > 0 && (jQuery('.vc_column-inner', thisColumn).css('background-image') != 'none'))) && (jQuery('.wpb_wrapper', thisColumn).html().trim() == '')) {
    ...
    jQuery(".tm-header-search-link a,tm-topbar-search-icon a").addClass('sclose');
    jQuery(".tm-header-search-link a").on('click', function() {
        jQuery(".field.searchform-s").focus();
        if (jQuery('.tm-header-search-link a').hasClass('sclose')) {
            jQuery(".tm-header-search-link a i").removeClass('tm-axacus-icon-search ').addClass('tm-axacus-icon-close');
            jQuery(this).removeClass('sclose').addClass('open');
            jQuery(".tm-search-overlay").addClass('st-show')
        } else {
            jQuery(this).removeClass('open').addClass('sclose');
            jQuery(".tm-header-search-link a i").removeClass('tm-axacus-icon-close').addClass('tm-axacus-icon-search ');
            jQuery(".tm-search-overlay").removeClass('st-show')
        }
    });
    jQuery(".tm-topbar-search-icon a").on('click', function() {
        jQuery(".tm-search-topbar-overlay").addClass('st-show');
    ...
    jQuery(".tm-icon-close").on('click', function() {
        jQuery(".tm-search-topbar-overlay").removeClass('st-show');
...
jQuery(window).load(function() {
    ...
    (function() {
        ...
        jQuery('.menu-toggle').on('click.axacus', function() {
...
function ts_hover_img() {
    const tsHoverImg = gsap.utils.toArray(".themetechmount-element-servicebox-styleone .themetechmount-box-bottom-content");
    tsHoverImg.forEach((target) => {
        const tsImg = target.querySelector('.themetechmount-box-bottom-content .themetechmount-overlay');
        ...
        target.tsHoverAnim = t1.play().reversed(!0);
